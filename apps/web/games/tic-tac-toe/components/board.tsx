...
export const TicTacToeBoard: React.FC<{
	...
	return (
		<div className="w- max-w-sm aspect-square relative">
			<div className="w-fit grid grid-cols-3 grid-rows-3 gap-[1px]">
				{board.map((cell, idx) => (
					<motion.button
						key={idx}
						initial={{
						...
						className={cn(
							"w-[6rem] h-[6rem] md:w-[8rem] md:h-[8rem] text-center text-2xl font-bold text-white border-2 rounded-md shadow-md shadow-primary/20 hover:shadow-primary/40 hover:shadow-lg cursor-pointer",
